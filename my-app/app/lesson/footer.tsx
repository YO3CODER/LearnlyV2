      ...
      <div className="max-w-[1140px] h-full mx-auto flex items-center justify-between px-6 lg:px-10">
        ...
        {status === "correct" && (
          <div className="flex items-center gap-x-3">
            <div className="w-10 h-10 lg:w-14 lg:h-14 rounded-2xl bg-green-700 flex items-center justify-center shrink-0 shadow-lg">
              <CheckCircle className="h-5 w-5 lg:h-7 lg:w-7 texte-gray stroke-[2.7]" />
            </div>
        ...
        {status === "completed" && (
          <Button
            ...
            className="rounded-xl font-bold border-2 border-b-4 border-slate-600 bg-slate-700 hover:bg-slate-600 texte-gray"
          >
            Pratiquer à nouveau
          </Button>
        )}
        ...
        <Button
          ...
          className={cn(
            ...
            status === "none" &&
            "bg-green-500 hover:bg-green-600 texte-gray border-green-600",

            status === "correct" &&
            "bg-green-500 hover:bg-green-600 texte-gray border-green-700 scale-105",

            status === "wrong" &&
            "bg-red-400 hover:bg-red-500 texte-gray opacity-70 border-red-600",
