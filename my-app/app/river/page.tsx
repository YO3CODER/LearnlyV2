...
type GameId = 'piano' | 'expression' | 'gamification' | 'souris' | 'memory';
    ...
    if (newSelected.length === 2) {
      ...
      if (a.id === b.id) {
        setTimeout(() => {
          ...
          setSelected([]);
          setLocked(false);
          if (next.filter(c => !c.matched && c.id !== a.id).every(c => c.matched || c.id === a.id)) {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="text-white text-xs font-semibold select-none" style={fredoka}>
                    {card.label}
                  </span>
                </div>
              </div>
...
// ─── Fullscreen Rive — monté uniquement quand activeGame !== null ─────────────
function FullscreenGame({ gameId, onClose }: { gameId: Exclude<GameId, 'memory'>; onClose: () => void }) {
  const gameMap: Record<Exclude<GameId, 'memory'>, { src: string; sm: string }> = {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-muted overflow-hidden" style={{ height: 200 }}>
        ...
        {/* Cas 1 : preview custom (ex: Memory) */}
        {customPreview && (
        ...
        {/* Cas 2 : preview statique image (ex: piano.png) */}
        ...
        {/* Cas 3 : preview Rive chargée uniquement au hover */}
        {!customPreview && !staticPreview && (
          <>
            {!hovered && (
              <div className="absolute inset-0 flex items-center justify-center">
...
export default function RiverPage() {
  ...
  return (
    <>
      ...
      {/* Jeux Rive — montés seulement au clic, démontés à la fermeture */}
      {activeGame !== null && activeGame !== 'memory' && (
        <FullscreenGame
          gameId={activeGame as Exclude<GameId, 'memory'>}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 space-y-12">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                ...
                {/* Memory — preview animée CSS, zéro dépendance */}
                <GameCard
                ...
                {/* Piano : preview statique — piano.riv (24 MB) jamais fetch avant clic */}
                <GameCard
