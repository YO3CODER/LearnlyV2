      ...
      >
        ...
        <div className="flex flex-col items-center lg:items-start gap-y-8">
          ...
          <div className="space-y-3 text-center lg:text-left">
            ...
            <p className="text-slate-400 text-sm lg:text-base font-medium max-w-[380px]">
                ...
                <>
                  ...
                  <SignInButton mode="modal">
                    <Button
                      ...
                      className="w-full rounded-xl font-semibold border-slate-200
                        text-slate-500 hover:bg-slate-50 transition-all duration-200"
                    >
